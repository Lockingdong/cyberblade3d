...
func TestDecodeMessageValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "bad flags", input: `{"type":"state","matchId":"m_1","seq":1,"t":0.1,"p1":{"p":[0,1,2],"rpm":4000,"st":90,"f":32},"p2":{"p":[2,1,0],"rpm":3900,"st":80,"f":0}}`, wantErr: true},
		{name: "state with special gauge", input: `{"type":"state","matchId":"m_1","seq":1,"t":0.1,"p1":{"p":[0,1,2],"rpm":4000,"st":90,"f":24,"sc":1},"p2":{"p":[2,1,0],"rpm":3900,"st":80,"f":0,"sc":0.4}}`},
		{name: "special gauge over full", input: `{"type":"state","matchId":"m_1","seq":1,"t":0.1,"p1":{"p":[0,1,2],"rpm":4000,"st":90,"f":0,"sc":1.5},"p2":{"p":[2,1,0],"rpm":3900,"st":80,"f":0,"sc":0}}`, wantErr: true},
		{name: "special event", input: `{"type":"battle_event","matchId":"m_1","eventId":1,"stateSeq":2,"t":0.2,"event":{"kind":"special","top":"p2","move":"drake_pierce","p":[0,0.8,0]}}`},
		{name: "unknown special move", input: `{"type":"battle_event","matchId":"m_1","eventId":1,"stateSeq":2,"t":0.2,"event":{"kind":"special","top":"p2","move":"nuke","p":[0,0.8,0]}}`, wantErr: true},
		{name: "special request", input: `{"type":"special","matchId":"m_1"}`},
