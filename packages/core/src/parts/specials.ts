...
export const SPECIAL_MOVES: Record<SpecialMoveId, SpecialMove> = {
  blaze_rush: {
    ...
    description: "朝對手瞬間衝刺，下一次命中造成 2 倍傷害且自身不受傷。",
    duration: 3,
    role: "offense",
  },
  drake_pierce: {
  ...
  falcon_evade: {
    ...
    description:
      "立即回復 18% 轉速，3 秒內碰撞傷害減半、轉速不衰減、移動速度提升。",
    duration: 3,
    role: "guard",
  },
  jade_resonance: {
    ...
    description: "立即回復 25% 穩定度與 15% 轉速。",
    duration: 0.8,
    role: "recovery",
  },
  chameleon_mimic: {
    ...
    description:
      "4 秒內質量、攻擊倍率與減傷強化 50%，若對手更強則直接複製對手的數值。",
    duration: 4,
    role: "mimic",
  },
};
